...
- **Re-BUY tras stop-out reciente es veneno — la señal más fuerte medida en la base** (2026-07-22, disparada por el caso NEM del dueño: 22 re-BUYs, −0.95R promedio): BUY con stop-out del MISMO símbolo en los 10 días previos = **10.3% win / −0.69R (n=156)** vs BUY fresco 45.8% / +0.16R (n=818). Robusto sin los 3 peores símbolos (NEM/CAAP/VIST): 11.6% / −0.64R (n=112). Eliminar esas señales habría ahorrado ~+108R — nada de lo medido se le acerca. Regla ACTIVA desde 2026-07-22: `stopoutCooldownAdjustment` degrada COMPRAR→OBSERVAR si hubo stop-out ≤`HOY_STOPOUT_COOLDOWN_DAYS` (default 10; solo degrada, jamás sube; caveat cita la evidencia), aplicada en la vista Y en el verbo persistido de `today_proposals`.
